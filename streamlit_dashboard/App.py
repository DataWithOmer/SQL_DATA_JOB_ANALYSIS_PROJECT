...
if page == "📑 Project Overview":
    ...
    with col_tech:
        ...
        <div style='background-color:#0f172a; border-left: 4px solid #10b981; padding:18px; border-radius:8px;'>
            ...
            • <b style='color:#e2e8f0;'>SQL Database:</b> PostgreSQL<br>
    ...
    with col_dev:
        ...
        <div style='text-align:left; padding:15px 0 10px 0;'>
            ...
            <p style='color:#10b981; font-size:18px; font-weight:700; margin:0 0 12px 0;'>Muhammad Omer Faisal</p>
...
# Page 4: Skill Economics
    ...
    # Skills dropdown
    skills_list_sql = """SELECT DISTINCT(skills) AS skills FROM skills_dim ORDER BY skills ASC"""
