...
# PAGE 2: Analytcis Dashboard
    ...
    st.markdown('<hr style="margin-top:-3px; margin-bottom:42px; border: 1px solid rgba(255,255,255,0.1)">', unsafe_allow_html=True)
...
# Page 3: Salary Insights
    ...
    st.markdown('<hr style="margin-top:-5px; margin-bottom:39px; border: 1px solid rgba(255,255,255,0.1)">', unsafe_allow_html=True)
